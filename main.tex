...
\title  {ctDNA for precision medicine in Non-small cell lung cancer}
...
\input{Chapters/Introduction/main-Introduction.tex} % Introduction

\input{Chapters/Variantcalling/main-Variantcalling.tex} % Background Theory 

\input{Chapters/CASCADE/main-CASCADE.tex} % Experimental Setup

\input{Chapters/mismatchfinder/main-Mismatchfinder.tex} % Experiment 1
