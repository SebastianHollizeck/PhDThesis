...
%reference managing
\usepackage[sorting=none, citestyle=numeric-comp, sortcites, backend=biber, giveninits=true]{biblatex}
...
\newcommand{\myequation}[2][AAA]{%
	\addcontentsline{equ}{myequations}{\protect\numberline{#1}{\ignorespaces #2}}\par
}
\setlength{\cftmyequationsnumwidth}{3em}    % Length must be defined before it can be set - it isn't defined until you've created the new list
\setlength{\cftmyequationsindent}{\cfttabindent}
...
% custom hyphenation
\hyphenation{germ-line}
\hyphenation{me-la-no-ma}
\hyphenation{anti-tu-mour-i-gen-ic}
\hyphenation{nu-cle-o-tide}
...
%exchange finalnew for margins for the final version
...
\school{{Faculty of Medicine, Dentistry, and Health Sciences}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\fancyhead[LE,RO]{\emph{List of Listings}}
...
\textbf{CASCADE} & \textbf{CA}ncer ti\textbf{S}sue \textbf{C}ollection \textbf{A}fter \textbf{DE}ath \\
...
\textbf{PCx} & \textbf{P}rincipal \textbf{C}omponent number x \\
...
\textbf{SNV} & \textbf{S}ingle \textbf{N}ucleotide \textbf{V}ariant \\
...
\input{Appendices/CASCADE/app-main.tex}

\input{Appendices/Mismatchfinder/app-main.tex}
