...
For the clustering of variants all variants with no known protein changing function were included, by removing all variants with the VEP consequence ``intergenic\_variant``, ``intron\_variant``, ``upstream\_gene\_variant``, or ``downstream\_gene\_variant``. While these variants certainly might distinguish clones within the sample, they could only arise through random genetic drift and did not relate to resistance mechanisms. 
