...
With the help of the WES of both the tissue and the cfDNA samples, we know what the expected outcome for each of the lcWGS samples is, as the standard procedure for signature detection starts with somatic variants.  Strelka2 was used to call somatic variants and the high confidence somatic SNPs were then used in R to generate signature weights with sigminer using default parameters for the GRCh38 genome build and the QP deconstruction method \cite{Wang2021}.
