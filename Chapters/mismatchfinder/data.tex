...
The following section discusses the results for the simulation of the very distinct SBS7a UV signature (see \autoref{fig:sig7a}) which is predominantly present in Melanoma (\autoref{mmf-sec:melaSim}) and secondly the much flatter and more uniform SBS3 (\autoref{A:fig:sig3}), which is a sign of defective homologous recombination in breast and other cancers (\autoref{mmf-sec:mbcSim}). 
